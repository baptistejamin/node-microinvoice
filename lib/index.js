...
module.exports = class Microinvoice {
  ...
  setText(text, options = {}) {
    ...
    let _onNewPageAdded = options.onNewPageAdded

    this.storage.cursor.y += _marginTop;
    this.setTextStyle(text, options);
    const textToRender = this.valueOrTransliterate(text);
    const currentSectionHeight = this.document.heightOfString(textToRender, { width: _maxWidth });
